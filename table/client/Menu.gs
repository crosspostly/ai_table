...
Импортирует посты из Instagram и Telegram с автоматической фильтрацией.

📋 Что делает:
• Загружает посты из Instagram или Telegram
...
3. В ячейку B1: ссылка или username
   • Instagram: https://instagram.com/username или username
   • Telegram: https://t.me/channel или @channel
4. В ячейку B2: количество постов (1-100, по умолчанию 50)
5. [Опционально] В C1: платформа ("инста" или "тг", или пустым для auto-detect)
...
⏳ Импорт VK будет добавлен в следующих версиях`;
